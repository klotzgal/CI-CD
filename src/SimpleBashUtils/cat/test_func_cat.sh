...
declare -a tests=(
    "VAR ../common/test_case_cat.txt"
)

declare -a extra=(
"-s ../common/test_1_cat.txt"
"-b -e -n -s -t -v ../common/test_1_cat.txt"
"-t ../common/test_3_cat.txt"
"-n ../common/test_2_cat.txt"
"no_file.txt"
"-n -b ../common/test_1_cat.txt"
"-s -n -e ../common/test_4_cat.txt"
"../common/test_1_cat.txt"
"-n ../common/test_1_cat.txt"
"-n ../common/test_1_cat.txt test_2_cat.txt"
"-v ../common/test_5_cat.txt"
)
